...
st.markdown("""
<style>
    /* IMPORT FONTS: Playfair (Luxury) & Lato (Clean) */
...
def main():
    ...
    if not artifacts:
        st.error("System Offline. Model missing.")
        st.stop()
    ...
    if st.session_state.pred is not None:
        ...
        with col_risk:
            ...
            st.markdown("<div style='text-align: center; margin-bottom: 10px;'><span class='kpi-label'>CANCELLATION PROBABILITY</span></div>", unsafe_allow_html=True)
